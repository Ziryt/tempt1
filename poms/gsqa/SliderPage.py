...
class SliderPage:
    ...
    cp_iframe_color = Container(locator='ui-widget-content ui-corner-all', by=By.CLASS_NAME)
    ...
    def set_picker_color(self, red, green, blue):
        self.cp_iframe_red.dragndrop(red, 0)
        self.cp_iframe_green.dragndrop(green, 0)
        self.cp_iframe_blue.dragndrop(blue, 0)
