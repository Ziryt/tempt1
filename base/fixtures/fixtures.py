...
def alert_box_page(driver):
    driver.visit('https://www.globalsqa.com/demo-site/alertbox/')
    return AlertBoxPage()
...
def drag_and_drop_page(driver):
    driver.visit('https://www.globalsqa.com/demo-site/draganddrop/')
    return DraggableBoxesPage()


@pytest.fixture
def draggable_boxes_page(driver):
    driver.visit('https://www.globalsqa.com/demo-site/draggableboxes/')
